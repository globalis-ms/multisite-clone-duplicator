...
0. Upload multisite-clone-duplicator/ to the `/wp-content/plugins/` directory
0. Activate the plugin through the 'Plugins' menu in WordPress
0. (Optional) Chmod 777 the logs/ directory of the plugin, if you want to activate logs
0. Go to My Sites > Network Admin > Duplication and enjoy !
0. (Optional) Change default options into Network dashboard > Network settings > Duplication
