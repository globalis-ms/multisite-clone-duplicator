...
if ( ! class_exists( 'MUCD_Functions' ) ) {
	...
	class MUCD_Functions {
		...
		public static function get_site_list() {
			...
			$network_blogs = get_sites( array( 'limit' => MUCD_MAX_NUMBER_OF_SITE ) );
		...
		/**
		 * Check if a value is in an object for a specific key
		 * @since 0.2.0
		 *
		 ...
		 * @return boolean true | false
		 */
		public static function value_in_object( $value, $object, $key ) {
